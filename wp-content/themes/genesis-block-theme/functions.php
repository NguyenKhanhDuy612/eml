...
add_filter('radio_buttons_for_taxonomies_no_term_state', '__return_FALSE');
add_filter('radio_buttons_for_taxonomies_no_term_curriculum', '__return_FALSE');

function custom_theme_assets()
{
	//custom css
	wp_enqueue_style('main-style', get_stylesheet_directory_uri() . '/asset/css/style.css?v=1.' . rand(0, 999));

	wp_enqueue_script('gform-script', get_stylesheet_directory_uri() . '/js/gform.js?v=1.' . rand(0, 999));
	// // wp_enqueue_script('swiper-script', get_stylesheet_directory_uri() . '/assets/js/swiper.js?v=1.' . rand(0, 999));
	// wp_enqueue_script('swiper-js-script', get_stylesheet_directory_uri() . '/assets/js/swiper.js?v=1.' . rand(0, 999));
}
add_action('wp_enqueue_scripts', 'custom_theme_assets', 20, 2);
